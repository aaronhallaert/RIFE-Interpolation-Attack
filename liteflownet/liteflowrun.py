...
class Network(torch.nn.Module):
        def __init__(self):
                ...
                self.load_state_dict({ strKey.replace('module', 'net'): tenWeight for strKey, tenWeight in torch.hub.load_state_dict_from_url(url='http://content.sniklaus.com/github/pytorch-liteflownet/network-' + "sintel" + '.pytorch', file_name='liteflownet-' + "sintel").items() })
        # end
